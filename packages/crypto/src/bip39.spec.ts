...
describe("Bip39", () => {
  describe("encode", () => {
    ...
    it("throws for invalid input", () => {
      ...
      expect(() => Bip39.encode(fromHex(""))).toThrow(/invalid input length/);
      expect(() => Bip39.encode(fromHex("00"))).toThrow(/invalid input length/);
      expect(() => Bip39.encode(fromHex("000000000000000000000000000000"))).toThrow(
        /invalid input length/,
      );
      expect(() => Bip39.encode(fromHex("0000000000000000000000000000000000"))).toThrow(
        /invalid input length/,
      );
      expect(() => Bip39.encode(fromHex("0000000000000000000000000000000000000000000000"))).toThrow(
        /invalid input length/,
      );
      expect(() => Bip39.encode(fromHex("00000000000000000000000000000000000000000000000000"))).toThrow(
        /invalid input length/,
      );
      expect(() =>
...
describe("EnglishMnemonic", () => {
  ...
  it("rejects invalid whitespacing", () => {
    ...
    ).toThrow(/invalid mnemonic format/i);
    expect(
      () =>
        new EnglishMnemonic(
          "abandon  abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about",
  ...
  it("word counts other than 12, 15, 18, 21, 24", () => {
    ...
    ).toThrow(/invalid word count(.*)got: 17/i);
    expect(
      () =>
        new EnglishMnemonic(
    ...
    ).toThrow(/invalid word count(.*)got: 19/i);
    expect(
      () =>
        new EnglishMnemonic(
    ...
    ).toThrow(/invalid word count(.*)got: 23/i);
    expect(
      () =>
        new EnglishMnemonic(
  ...
  it("rejects valid mnemonics of other languages", () => {
    ...
    ).toThrow(/contains invalid word/i);
    expect(
      () =>
        new EnglishMnemonic(
