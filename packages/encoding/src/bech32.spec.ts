...
describe("bech32", () => {
  ...
  describe("toBech32", () => {
    ...
    it("works for very long prefixes", () => {
      expect(() => toBech32("p".repeat(70), new Uint8Array(20))).toThrow(/exceeds length limit/i);
    });
    ...
    it("throws if result exceeds 90 characters", () => {
      expect(() => toBech32("eth", new Uint8Array(51))).toThrow(/exceeds length limit/i);
    });
    ...
    it("throws if result exceeds the provided limit parameter", () => {
      const limit = 10;
      expect(() => toBech32("eth", ethAddressRaw, limit)).toThrow(/exceeds length limit/i);
    });
  });
  ...
  describe("fromBech32", () => {
    ...
    it("throws for addresses which exceed the specification limit of 90 characters if a limit is specified", () => {
      ...
      ).toThrow(/exceeds length limit/i);
    });

    it("throws for mixed case addresses", () => {
      // "Decoders MUST NOT accept strings where some characters are uppercase and some are lowercase (such strings are referred to as mixed case strings)."
      // https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki
      expect(() => fromBech32("Eth1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => fromBech32("eTh1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => fromBech32("ETH1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => fromBech32("eth1n48g2mjh9Ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
    });
  ...
  describe("normalizeBech32", () => {
    ...
    it("throws for mixed case addresses", () => {
      // "Decoders MUST NOT accept strings where some characters are uppercase and some are lowercase (such strings are referred to as mixed case strings)."
      // https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki
      expect(() => normalizeBech32("Eth1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => normalizeBech32("eTh1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => normalizeBech32("ETH1n48g2mjh9ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
      expect(() => normalizeBech32("eth1n48g2mjh9Ezz7zjtya37wtgg5r5emr0drkwlgw")).toThrow(/Mixed-case/i);
    });
