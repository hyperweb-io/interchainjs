 ...
 */
export const useGetL3DerivativeOrderBook = buildUseVueQuery<QueryFullDerivativeOrderbookRequest, QueryFullDerivativeOrderbookResponse>({
 ...
 */
export const useGetL3SpotOrderBook = buildUseVueQuery<QueryFullSpotOrderbookRequest, QueryFullSpotOrderbookResponse>({
 ...
 */
export const useGetMarketBalance = buildUseVueQuery<QueryMarketBalanceRequest, QueryMarketBalanceResponse>({
 ...
 */
export const useGetMarketBalances = buildUseVueQuery<QueryMarketBalancesRequest, QueryMarketBalancesResponse>({
 ...
 */
export const useGetDenomMinNotional = buildUseVueQuery<QueryDenomMinNotionalRequest, QueryDenomMinNotionalResponse>({
 ...
 */
export const useGetDenomMinNotionals = buildUseVueQuery<QueryDenomMinNotionalsRequest, QueryDenomMinNotionalsResponse>({
