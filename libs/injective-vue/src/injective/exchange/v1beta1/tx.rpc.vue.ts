...
/**
 * @name useBatchExchangeModification
 * @package injective.exchange.v1beta1
 * @see proto service: injective.exchange.v1beta1.BatchExchangeModification
 */
export const useBatchExchangeModification = buildUseVueMutation<MsgBatchExchangeModification, Error>({
  builderMutationFn: batchExchangeModification
});