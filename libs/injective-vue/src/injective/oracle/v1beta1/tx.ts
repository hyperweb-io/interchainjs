...
export interface MsgRelayStorkPricesAmino {
  sender: string;
  asset_pairs: AssetPairAmino[];
}
export interface MsgRelayStorkPricesAminoMsg {
...
export interface MsgRelayStorkPricesResponseAminoMsg {
  ...
  value: MsgRelayStorkPricesResponseAmino;
}
/**
...
export const MsgRelayProviderPrices = {
  ...
  toAminoMsg(message: MsgRelayProviderPrices): MsgRelayProviderPricesAminoMsg {
    return {
      type: "oracle/MsgRelayProviderPrices",
      value: MsgRelayProviderPrices.toAmino(message)
    };
  },
...
export const MsgRelayPriceFeedPrice = {
  ...
  toAminoMsg(message: MsgRelayPriceFeedPrice): MsgRelayPriceFeedPriceAminoMsg {
    return {
      type: "oracle/MsgRelayPriceFeedPrice",
      value: MsgRelayPriceFeedPrice.toAmino(message)
    };
  },
...
export const MsgRelayBandRates = {
  ...
  toAminoMsg(message: MsgRelayBandRates): MsgRelayBandRatesAminoMsg {
    return {
      type: "oracle/MsgRelayBandRates",
      value: MsgRelayBandRates.toAmino(message)
    };
  },
...
export const MsgRelayCoinbaseMessages = {
  ...
  toAminoMsg(message: MsgRelayCoinbaseMessages): MsgRelayCoinbaseMessagesAminoMsg {
    return {
      type: "oracle/MsgRelayCoinbaseMessages",
      value: MsgRelayCoinbaseMessages.toAmino(message)
    };
  },
...
export const MsgRelayStorkPrices = {
  ...
  is(o: any): o is MsgRelayStorkPrices {
    return o && (o.$typeUrl === MsgRelayStorkPrices.typeUrl || typeof o.sender === "string" && Array.isArray(o.assetPairs) && (!o.assetPairs.length || AssetPair.is(o.assetPairs[0])));
  },
  isAmino(o: any): o is MsgRelayStorkPricesAmino {
    return o && (o.$typeUrl === MsgRelayStorkPrices.typeUrl || typeof o.sender === "string" && Array.isArray(o.asset_pairs) && (!o.asset_pairs.length || AssetPair.isAmino(o.asset_pairs[0])));
  },
  encode(message: MsgRelayStorkPrices, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRelayStorkPrices {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(object: DeepPartial<MsgRelayStorkPrices>): MsgRelayStorkPrices {
    const message = createBaseMsgRelayStorkPrices();
    message.sender = object.sender ?? "";
    message.assetPairs = object.assetPairs?.map(e => AssetPair.fromPartial(e)) || [];
    return message;
  },
  fromAmino(object: MsgRelayStorkPricesAmino): MsgRelayStorkPrices {
    const message = createBaseMsgRelayStorkPrices();
    if (object.sender !== undefined && object.sender !== null) {
      message.sender = object.sender;
    }
    message.assetPairs = object.asset_pairs?.map(e => AssetPair.fromAmino(e)) || [];
    return message;
  },
  toAmino(message: MsgRelayStorkPrices): MsgRelayStorkPricesAmino {
    const obj: any = {};
    obj.sender = message.sender === "" ? undefined : message.sender;
    if (message.assetPairs) {
      obj.asset_pairs = message.assetPairs.map(e => e ? AssetPair.toAmino(e) : undefined);
    } else {
      obj.asset_pairs = message.assetPairs;
    }
    return obj;
  },
  fromAminoMsg(object: MsgRelayStorkPricesAminoMsg): MsgRelayStorkPrices {
    return MsgRelayStorkPrices.fromAmino(object.value);
  },
  fromProtoMsg(message: MsgRelayStorkPricesProtoMsg): MsgRelayStorkPrices {
    return MsgRelayStorkPrices.decode(message.value);
  },
  toProto(message: MsgRelayStorkPrices): Uint8Array {
    return MsgRelayStorkPrices.encode(message).finish();
  },
  toProtoMsg(message: MsgRelayStorkPrices): MsgRelayStorkPricesProtoMsg {
    return {
      typeUrl: "/injective.oracle.v1beta1.MsgRelayStorkPrices",
...
export const MsgRelayStorkPricesResponse = {
  ...
  is(o: any): o is MsgRelayStorkPricesResponse {
    return o && o.$typeUrl === MsgRelayStorkPricesResponse.typeUrl;
  },
  isAmino(o: any): o is MsgRelayStorkPricesResponseAmino {
    return o && o.$typeUrl === MsgRelayStorkPricesResponse.typeUrl;
  },
  encode(_: MsgRelayStorkPricesResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRelayStorkPricesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial(_: DeepPartial<MsgRelayStorkPricesResponse>): MsgRelayStorkPricesResponse {
    const message = createBaseMsgRelayStorkPricesResponse();
    return message;
  },
  fromAmino(_: MsgRelayStorkPricesResponseAmino): MsgRelayStorkPricesResponse {
    const message = createBaseMsgRelayStorkPricesResponse();
    return message;
  },
  toAmino(_: MsgRelayStorkPricesResponse): MsgRelayStorkPricesResponseAmino {
    const obj: any = {};
    return obj;
  },
  fromAminoMsg(object: MsgRelayStorkPricesResponseAminoMsg): MsgRelayStorkPricesResponse {
    return MsgRelayStorkPricesResponse.fromAmino(object.value);
  },
  fromProtoMsg(message: MsgRelayStorkPricesResponseProtoMsg): MsgRelayStorkPricesResponse {
    return MsgRelayStorkPricesResponse.decode(message.value);
  },
  toProto(message: MsgRelayStorkPricesResponse): Uint8Array {
    return MsgRelayStorkPricesResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgRelayStorkPricesResponse): MsgRelayStorkPricesResponseProtoMsg {
    return {
      typeUrl: "/injective.oracle.v1beta1.MsgRelayStorkPricesResponse",
...
export const MsgRequestBandIBCRates = {
  ...
  toAminoMsg(message: MsgRequestBandIBCRates): MsgRequestBandIBCRatesAminoMsg {
    return {
      type: "oracle/MsgRequestBandIBCRates",
      value: MsgRequestBandIBCRates.toAmino(message)
    };
  },
...
export const MsgRelayPythPrices = {
  ...
  toAminoMsg(message: MsgRelayPythPrices): MsgRelayPythPricesAminoMsg {
    return {
      type: "oracle/MsgRelayPythPrices",
      value: MsgRelayPythPrices.toAmino(message)
    };
  },
