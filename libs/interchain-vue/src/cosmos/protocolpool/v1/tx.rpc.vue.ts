 ...
 */
export const useCreateContinuousFund = buildUseVueMutation<MsgCreateContinuousFund, Error>({
 ...
 */
export const useCancelContinuousFund = buildUseVueMutation<MsgCancelContinuousFund, Error>({
