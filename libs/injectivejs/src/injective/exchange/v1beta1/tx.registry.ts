...
export const MessageComposer = {
  encoded: {
    ...
    batchExchangeModification(value: MsgBatchExchangeModification) {
      return {
        typeUrl: "/injective.exchange.v1beta1.MsgBatchExchangeModification",
        value: MsgBatchExchangeModification.encode(value).finish()
      };
    }
  },
  withTypeUrl: {
  ...
  fromPartial: {
    ...
    batchExchangeModification(value: MsgBatchExchangeModification) {
      return {
        typeUrl: "/injective.exchange.v1beta1.MsgBatchExchangeModification",
        value: MsgBatchExchangeModification.fromPartial(value)
      };
    }
  }
};